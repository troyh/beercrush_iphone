...
#define BEERCRUSH_API_URL_GET_BEER_PERSONALIZATION		@BEERCRUSH_API_URL_HOST"/api/beer/%@/%@/personalization"
#define BEERCRUSH_API_URL_GET_BEER_PHOTOSET_DOC			@BEERCRUSH_API_URL_HOST"/api/photoset/%@/%@/%@"
...
#define BEERCRUSH_API_URL_GET_BREWERYORPLACE_PHOTOSET_DOC		@BEERCRUSH_API_URL_HOST"/api/photoset/%@/%@"
...
#define BEERCRUSH_API_URL_GET_USER_BEER_REVIEWS_DOC		@BEERCRUSH_API_URL_HOST"/api/user/%@/reviews"
#define BEERCRUSH_API_URL_GET_USER_INFO					@BEERCRUSH_API_URL_HOST"/api/user/%@"
...
#define BEERCRUSH_API_URL_POST_USER_PROFILE				@BEERCRUSH_API_URL_HOST"/api/user/edit"
