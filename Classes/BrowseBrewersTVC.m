...
- (void)viewWillAppear:(BOOL)animated {
	...
	[appDelegate performAsyncOperationWithTarget:self selector:@selector(getBreweriesList:) object:nil requiresUserCredentials:NO activityHUDText:NSLocalizedString(@"HUD:GettingBrewery",@"Getting Brewery List")];
